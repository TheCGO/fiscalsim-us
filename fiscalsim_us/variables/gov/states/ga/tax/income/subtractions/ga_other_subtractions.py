...
class ga_other_subtractions(Variable):
    value_type = float
    entity = TaxUnit
    label = "Georgia other subtractions from income"
    unit = USD
    definition_period = YEAR
    reference = (
        "https://dor.georgia.gov/document/document/2022-it-511-individual-income-tax-booklet/download#page=34"
    ...
    # From line 12 of Georgia tax form 500 Schedule 1
    # Also a catch all for any non-implemented subtractions (all fo the 2022
    # ones have been inplemented)
